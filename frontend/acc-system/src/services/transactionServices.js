...
const API_BASE_URL = 'https://master.d1ett1tvi16xqx.amplifyapp.com/transactions'; 
...
export const getTransactionById = async (id) => {
    try {
        const response = await axios.get(`${API_BASE_URL}/get-transaction/${id}`);
        return response.data;
    } catch (error) {
...
export const createTransaction = async (transactionData) => {
  try {
      const response = await axios.post(`${API_BASE_URL}/create-transaction`, transactionData);
      return response.data;
  } catch (error) {
...
export const updateTransaction = async (id, updateData) => {
    try {
        ...
        const response = await axios.put(`${API_BASE_URL}/update-transaction/${id}`, updateData);
        return response.data;
    } catch (error) {
...
export const deleteTransaction = async (id) => {
  try {
      const response = await axios.delete(`${API_BASE_URL}/delete-transaction/${id}`);
      return response.data;
  } catch (error) {
